...
const optionsSchema = Joi.object({
    ...
    // added the following five options for handlebar templates
    relativeTo: Joi.string().optional(),
    contentTemplate: Joi.string().optional(),
    layoutTemplate: Joi.string().optional(),
    layoutPath: Joi.string().optional(),
    partialsPath: Joi.string().optional()
})
...
function register (plugin, options) {
    ...
    const internals = {
        handler (request, h) {
            ...
            if (swaggerEndpoint) {
                ...
                return h.view(settings.contentTemplate, context, {layout: settings.layoutTemplate})
            }
    ...
    plugin.views({
        ...
        // relativeTo is now available via settings
